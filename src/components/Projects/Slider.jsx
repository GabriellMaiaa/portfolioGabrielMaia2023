...
let data = [//Criar uma let com img e descricao do que é
  {
    ...
    desc5: 'Projeto construído no evento gratuito do nlw da rocketseat, com Next e Tailwind'
  }
]
...
const SliderComp = () => {
  ...
  return (
    <div>
      <Slider {...settings}>
    {/* {sliderProject} */}
        <Project img={jogo} desc={data.map((item) => item.desc1)} link='https://secret-word1-jogo.vercel.app/'/>
        ...
        <Project img={nlw} desc={data.map((item) => item.desc5)} link= 'https://interfacenext-nlw-2023.vercel.app/'/>
      </Slider>
    </div>
  )
}
